                ...
                <div class="col">
                    <form wire:submit.prevent="masukkanKeranjang">
                        <table class="table" style="border-top: hidden;">
                            ...
                            @if($jumlah_pesanan <= 1)
                            <tr>
                                <td colspan="3"><strong>Name Set (isi jika ingin menambahkan nameset)</strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="3">
                                    ...
                                    @if($product->is_ready !== 1) disabled @endif>
                                    <i class="fas fa-shopping-cart"></i> Masukan Keranjang</button>
                                </td>
                            </tr>
                        </table>
                    </form>
